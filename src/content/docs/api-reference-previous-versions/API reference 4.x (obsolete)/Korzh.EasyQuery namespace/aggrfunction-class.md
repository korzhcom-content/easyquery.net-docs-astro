...
slug: api-reference-previous-versions/API reference 4.x (obsolete)/Korzh.EasyQuery namespace/aggrfunction-class
---
...
| `Boolean` | Enabled | Gets or sets a value indicating whether this [Korzh.EasyQuery.AggrFunction](/api-reference-4x/korzh-easyquery-namespace/aggrfunction-class) is enabled. | 
