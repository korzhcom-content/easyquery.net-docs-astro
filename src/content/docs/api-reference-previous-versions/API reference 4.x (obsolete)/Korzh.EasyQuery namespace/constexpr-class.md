...
slug: api-reference-previous-versions/API reference 4.x (obsolete)/Korzh.EasyQuery namespace/constexpr-class
---
...
| `String` | TypeName | Non-static version of [Korzh.EasyQuery.ConstExpr.STypeName](/api-reference-4x/korzh-easyquery-namespace/constexpr-class) property. | 
