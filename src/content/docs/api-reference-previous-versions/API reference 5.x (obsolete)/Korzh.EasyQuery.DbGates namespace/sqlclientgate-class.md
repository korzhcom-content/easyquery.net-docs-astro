...
slug: api-reference-previous-versions/API reference 5.x (obsolete)/Korzh.EasyQuery.DbGates namespace/sqlclientgate-class
---


Represents [Korzh.EasyQuery.Db.DbGate](/api-reference-5x/korzh-easyquery-db-namespace/dbgate-class) implementation for MS SQL databases
```csharp
...
| `String` | GetName() | Gets the name of [Korzh.EasyQuery.DbGates.SqlClientGate](/api-reference-5x/korzh-easyquery-dbgates-namespace/sqlclientgate-class). | 
