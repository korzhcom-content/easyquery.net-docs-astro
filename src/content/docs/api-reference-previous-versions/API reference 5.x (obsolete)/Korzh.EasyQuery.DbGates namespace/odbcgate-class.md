...
slug: api-reference-previous-versions/API reference 5.x (obsolete)/Korzh.EasyQuery.DbGates namespace/odbcgate-class
---
...
| `String` | GetName() | Gets the name of [Korzh.EasyQuery.DbGates.OdbcGate](/api-reference-5x/korzh-easyquery-dbgates-namespace/odbcgate-class) object. | 
