...
slug: api-reference-previous-versions/API reference 5.x (obsolete)/Korzh.EasyQuery.DbGates namespace/odpcoregate-class
---


Represents DbGate implementation for Oracle Data Provider for .NET  Implements the [Korzh.EasyQuery.Db.DbGate](/api-reference-5x/korzh-easyquery-db-namespace/dbgate-class)
```csharp
...
| `String` | GetName() | Gets the name of [Korzh.EasyQuery.DbGates.OdpCoreGate](/api-reference-5x/korzh-easyquery-dbgates-namespace/odpcoregate-class) object. | 
