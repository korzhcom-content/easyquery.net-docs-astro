...
slug: api-reference-4x/korzh-easyquery-dbgates-namespace/sqlclientgate-class
---

Represents [Korzh.EasyQuery.Db.DbGate](//easyquery/docs/api-reference-4x/korzh-easyquery-db-namespace/dbgate-class) implementation for MS SQL databases
```csharp
...
| `String` | GetName() | Gets the name of [Korzh.EasyQuery.DbGates.SqlClientGate](//easyquery/docs/api-reference-4x/korzh-easyquery-dbgates-namespace/sqlclientgate-class). | 
