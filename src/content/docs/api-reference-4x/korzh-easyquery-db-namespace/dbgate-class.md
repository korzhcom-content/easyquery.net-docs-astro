...
| `Boolean` | UseViews | Gets or sets a value indicating whether [Korzh.EasyQuery.Db.DbGate](/easyquery/docs/api-reference-4x/korzh-easyquery-db-namespace/dbgate-class) will add views in the list of tables returned by [Korzh.EasyQuery.Db.DbGate.GetTables(System.String,System.String)](/easyquery/docs/api-reference-4x/korzh-easyquery-db-namespace/dbgate-class) method. | 
| `String` | Version | Gets the version of the current [Korzh.EasyQuery.Db.DbGate](/easyquery/docs/api-reference-4x/korzh-easyquery-db-namespace/dbgate-class) implementation | 
...
| Type | Name | Description | 
| --- | --- | --- | 
| `LoginRequestEventHandler` | LoginRequest | Occurs when the [Korzh.EasyQuery.Db.DbGate](/easyquery/docs/api-reference-4x/korzh-easyquery-db-namespace/dbgate-class) objects needs to get [Korzh.EasyQuery.Db.DbGate.UserID](/easyquery/docs/api-reference-4x/korzh-easyquery-db-namespace/dbgate-class) and [Korzh.EasyQuery.Db.DbGate.Password](/easyquery/docs/api-reference-4x/korzh-easyquery-db-namespace/dbgate-class) to connect to some database. | 
...
| `void` | CoreLoadParams(`DbParameters` dbParams) | Core implementation of [Korzh.EasyQuery.Db.DbGate.LoadParams(Korzh.EasyQuery.Db.DbParameters)](/easyquery/docs/api-reference-4x/korzh-easyquery-db-namespace/dbgate-class) method. | 
| `void` | CoreSaveParams(`DbParameters` dbParams) | Core implementation of [Korzh.EasyQuery.Db.DbGate.SaveParams(Korzh.EasyQuery.Db.DbParameters)](/easyquery/docs/api-reference-4x/korzh-easyquery-db-namespace/dbgate-class) method. | 
...
| `String` | GetName() | Gets the name of [Korzh.EasyQuery.Db.DbGate](/easyquery/docs/api-reference-4x/korzh-easyquery-db-namespace/dbgate-class). Must be overrided in inherited classes | 
...
| `String` | GetVersion() | Core implemenation of [Korzh.EasyQuery.Db.DbGate.Version](/easyquery/docs/api-reference-4x/korzh-easyquery-db-namespace/dbgate-class) property. Must be overrided in descendants. | 
