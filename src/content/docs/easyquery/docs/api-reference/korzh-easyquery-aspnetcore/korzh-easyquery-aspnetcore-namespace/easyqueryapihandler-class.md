...
slug: easyquery/docs/api-reference/korzh-easyquery-aspnetcore/korzh-easyquery-aspnetcore-namespace/easyqueryapihandler-class
---
...
| --- | --- | --- | 
| EasyQueryApiHandler([EasyQueryManager](/api-reference/korzh-easyquery/korzh-easyquery-services-namespace/easyquerymanager-class) manager, `HttpContext` httpContext) | `void` | Initializes a new instance of the [Korzh.EasyQuery.AspNetCore.EasyQueryApiHandler](/api-reference/korzh-easyquery-aspnetcore/korzh-easyquery-aspnetcore-namespace/easyqueryapihandler-class) class. | 
...
| Manager | [EasyQueryManager](/api-reference/korzh-easyquery/korzh-easyquery-services-namespace/easyquerymanager-class) | An instance of EasyQueryManager that incapsulates all business logic of EasyQuery API | 
